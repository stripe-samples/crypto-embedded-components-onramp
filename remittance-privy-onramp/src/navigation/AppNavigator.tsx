    ...
    <SettingsProvider>
      <TransferProvider>
        ...
        >
          ...
          <Stack.Screen name="TransferSetup" component={TransferSetupScreen} options={{ title: 'Transfer' }} />
          <Stack.Screen name="Wallet" component={WalletScreen} options={{ title: 'Authorize Transfer' }} />
          ...
          />
          <Stack.Screen name="Checkout" component={CheckoutScreen} options={{ title: 'Review Transfer', headerBackVisible: false }} />
