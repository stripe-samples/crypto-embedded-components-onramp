  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      if (hasVerifiedIdentityTier) {
        navigation.navigate('TransferSetup', { customerId: authResult.customerId, authToken });
      } else {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.subtitle}>
        ...
        {' '}to verify identity and complete payments. Link securely saves your payment details so future transfers are faster.
      </Text>
      ...
      <TouchableOpacity
        ...
        disabled={loading}
      >
        {loading ? <ActivityIndicator color="#fff" /> : <Text style={styles.buttonText}>Create Link account</Text>}
      </TouchableOpacity>
